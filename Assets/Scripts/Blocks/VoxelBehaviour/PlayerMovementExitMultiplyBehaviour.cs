...
public class PlayerMovementExitMultiplyBehaviour : VoxelBehaviour{
	...
	private void RemoveModsConditional(ChunkLoader cl){
		...
		if(cl.playerMovement.CheckModifier(MovePresetProperty.GRAVITY_ACCELERATION, this.gravityMaxAccelerationTimeOperation))
			cl.playerMovement.RemoveModifier(MovePresetProperty.GRAVITY_ACCELERATION, this.gravityMaxAccelerationTimeOperation);
		if(cl.playerMovement.CheckModifier(MovePresetProperty.GRAVITY_MAX_ACCELERATION_TIME, this.gravityAccelerationOperation))
			cl.playerMovement.RemoveModifier(MovePresetProperty.GRAVITY_MAX_ACCELERATION_TIME, this.gravityAccelerationOperation);
